...
| Technology | Purpose |
|---|---|
| **Microsoft Power BI** | Dashboard development, visualization, data modeling, and interactive reporting |
| **Power Query** | Data cleaning, transformation, formatting, and preprocessing |
| **DAX (Data Analysis Expressions)** | Creation of reusable calculated measures and KPIs |
| **Microsoft Excel / CSV** | Data preparation and source-data handling |
| **GitHub** | Version control and project repository management |
| **GitLab** | Backup repository and additional version-control support |
| **Microsoft Teams** | Team communication and mentor coordination |
...
| Return Rate | **5.91%** |
| Returned Orders | **296** |
| Standard Class Order Share | **59.77%** |
| Loss-Making Orders | **20.40%** |
